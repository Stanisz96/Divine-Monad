...
namespace DivineMonad.Areas.Admin.Controllers
{
    ...
    public class CharactersBaseStatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Level,Experience,Stamina,Strength,Agility,Dexterity,Luck")] CharacterBaseStats characterBaseStats)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Level,Experience,Stamina,Strength,Agility,Dexterity,Luck")] CharacterBaseStats characterBaseStats)
        {
