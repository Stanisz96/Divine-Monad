...
namespace DivineMonad.Areas.Admin.Controllers
{
    ...
    public class CharactersBaseStatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Level,Experience,HP,Attack,Armor,Critic,Strength,Stamina,Agility")] CharacterBaseStats characterBaseStats)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Level,Experience,HP,Attack,Armor,Critic,Strength,Stamina,Agility")] CharacterBaseStats characterBaseStats)
        {
